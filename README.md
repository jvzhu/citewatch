...
- `tests/fixtures/crossref_mullaney_10.1017_S0021911816000577.json`: canonical Crossref metadata fixture.
- `tests/fixtures/openalex_mullaney_work.json`: OpenAlex work fixture.
- `tests/fixtures/openalex_citing_mullaney_page*.json`: recorded citing-works fixtures for tracker snapshot/diff tests.
